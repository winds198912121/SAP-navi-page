...
import { readExcelFile, downloadTemplate, type ColumnDef, type ImportResult } from '@/lib/import-export'
          ...
          <>
            ...
            <div className="admin-modal-body">
              <p style={{ fontSize: 13, color: 'var(--ink-2)', margin: '0 0 16px', lineHeight: 1.7 }}>
                Excelファイル（.xlsx）をアップロードして一括インポートします。1行目がヘッダー行として扱われます。
              </p>
              <button className="admin-btn admin-btn-sm" onClick={() => downloadTemplate(columns, templateFilename)} style={{ marginBottom: 16 }}>
                📄 テンプレートをダウンロード
              </button>

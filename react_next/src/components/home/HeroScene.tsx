'use client'
// ===========================================================
// HeroScene — 教室场景组件 (from admin-react)
// パンダ先生(PandaSensei) + たろうくん(Student) + 黒板 + 吹き出し
// ===========================================================
...
function PandaSensei() {
  return (
    <svg viewBox="0 0 360 460" aria-label="SAPパンダ先生">
      <defs>
        <radialGradient id="shadow-panda" cx="0.5" cy="0.5" r="0.5">
          <stop offset="0%" stopColor="rgba(0,0,0,0.22)" />
          <stop offset="100%" stopColor="rgba(0,0,0,0)" />
        </radialGradient>
      </defs>
      <ellipse cx="180" cy="438" rx="110" ry="10" fill="url(#shadow-panda)" />
      <g>
        ...
        <g transform="translate(20 322) rotate(-10)">
          ...
          <text x="29" y="7" fontSize="6" fontWeight="800" fill="#fff" textAnchor="middle" fontFamily="Inter, sans-serif">SAP BOOK</text>
      ...
      <g transform="translate(90 128)"><PandaHeadV2 mood="happy" wiggleEars={true} size={140} /></g>
    </svg>
  )
}
      ...
      <g transform="translate(110 150)">
        <g>
          ...
          <g className="eye-blink" style={{ transformOrigin: '38px 56px' }}>
            ...
            <circle cx="37" cy="55" r="0.9" fill="#fff" />
          </g>
...
function ChalkBoard() {
  return (
    <svg viewBox="0 0 200 160" preserveAspectRatio="xMidYMid meet" style={{ width: '100%', height: '100%' }}>
      <text x="20" y="26" fontSize="13" fill="rgba(255,240,200,0.95)" fontFamily="'Zen Maru Gothic', sans-serif" fontWeight="700">📐 今日のテーマ</text>
      <text x="20" y="44" fontSize="11" fill="rgba(255,240,200,0.85)" fontFamily="'Zen Maru Gothic', sans-serif">仕訳のしくみ</text>
      ...
      <text x="50" y="68" fontSize="10" fill="rgba(255,224,132,0.95)" fontFamily="'Zen Maru Gothic', sans-serif" textAnchor="middle">借方</text>
      <text x="150" y="68" fontSize="10" fill="rgba(255,179,196,0.95)" fontFamily="'Zen Maru Gothic', sans-serif" textAnchor="middle">貸方</text>
      <text x="36" y="94" fontSize="9" fill="rgba(255,255,255,0.85)" fontFamily="'Zen Maru Gothic', sans-serif" textAnchor="middle">現金 100</text>
      <text x="164" y="94" fontSize="9" fill="rgba(184,232,176,0.95)" fontFamily="'Zen Maru Gothic', sans-serif" textAnchor="middle">売上 100</text>
      <text x="36" y="118" fontSize="9" fill="rgba(255,255,255,0.75)" fontFamily="'Zen Maru Gothic', sans-serif" textAnchor="middle">受取手形 50</text>
      <text x="164" y="118" fontSize="9" fill="rgba(184,232,176,0.85)" fontFamily="'Zen Maru Gothic', sans-serif" textAnchor="middle">受取利息 50</text>
...
export default function HeroScene() {
  return (
    <div className="hero-scene">
      <div className="floor" />
      <div className="blackboard"><ChalkBoard /></div>
      <div className="hero-panda-wrap"><PandaSensei /></div>
      <div className="hero-student-wrap"><StudentTaro /></div>
      <FloatingCallouts />
    </div>
  )
}
